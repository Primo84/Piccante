...
const SalatTable = [
   ...
   ["GRECKA", "sa³ata lodowa, ser feta, pomidor, oliwki, sos", 18.90],

   ["TUNA", "sa³ata lodowa, tuñczyk, ogórek, kukurydza, cebula, sos", 18.90],

   ["TUTTI FRUTTI", "sa³ata lodowa, ogórek, kukurydza, ananas, kurczak, sos", 18.90]
...
const DinerTable = [
   ...
   ["Pierogi ukraiñskie(8 szt.)", 18.00],
   ["Pielmieni", 21.00],
   ["Kapsalon", 33.00],
   ["Frytki 200g", 14.00]
...
const PizzaTable = [
   ...
   ["11. CARUSO", "Sos pomidorowy, cebula, pieczarki, miêso, szynka, ser, oregano", "24,00", "33,50", "47,50", "66,30"],
   ...
   ["14. AL CAPONE", "Sos pomidorowy, cebula, pieczarki, szynka, kie³basa, ser, oregano", "23,90", "33,30", "47,30", "66,30"],
   ["15. RIMINI", "Sos pomidorowy, cebula, pieczarki, szynka, broku³y,ser, sos czosnkowy", "23,90", "33,20", "47,30", "66,20"],
   ...
   ["18. MONT BLANC", "Sos pomidorowy, czosnek, cebula, broku³y, kurczak, ser", "23,30", "33,50", "47,20", "66,20"],
   ["20. SOLARE", "Sos pomidorowy, szynka, salami, kukurydza, papryka, ser, oregano", "23,20", "33,30", "47,30", "66,30"],
   ["22. CASINO", "Sos pomidorowy, cebula, pieczarki, miêso, papryka, ser, oregano", "26,50", "34,20", "48,20", "66,20"],
   ...
   ["28. TUNA", "Sos pomidorowy, cebula, pieczarki, szynka, tuñczyk, szpinak, ser, oregano", "26,00", "32,50", "47,50", "66,20"],
   ["29. VEGETARIANA", "Sos pomidorowy, cebula, pieczarki, szpinak, broku³y, papryka, ser, oregano", "25,30", "33,50", "47,50", "66,50"],
   ["31. FARMERSKA", "Sos pomidorowy, cebula, pieczarki, papryka, kurczak, ser, oregano", "26,00", "33,00", "47,00", "66,50"],
   ["36. ROSA", "Sos pomidorowy, pieczarki, kurczak, pomidory, broku³y, ser, oregano", "26,50", "35,00", "48,00", "66,50"],
   ...
   ["41. WIEJSKA", "Sos pomidorowy, ser, boczek, salami, kie³basa, cebula, pieczarki, oregano", "26,90", "34,90", "50,90", "67,90"]
]